                            ...
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-gray-800" id="temp"><?= $datas[0]->Suhu; ?> ℃</div>
                                    </div>
                                    <div class="col-auto">
                    ...
                    <div class="col-12 col-sm-6 mb-4">
                        <div class="card border-left-warning shadow h-100 py-2">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Tingkat Kelembapan</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800" id="turbidity"><?= $datas[0]->Kelembaban; ?></div>
                                    </div>
                                    <div class="col-auto">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                <h6 class="m-0 font-weight-bold text-primary">Grafik Suhu Kandang</h6>
                    ...
                    <div class="col-12 col-sm-6">
                        <div class="card shadow mb-4">
                            <!-- Card Header - Dropdown -->
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                <h6 class="m-0 font-weight-bold text-warning">Grafik Kelembaban Kandang</h6>
                                <div class="dropdown no-arrow">
                                    <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                                    </a>
                            ...
                            <div class="card-body">
                                <div class="chart-area">
                                    <canvas id="myTurbidityChart"></canvas>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    // Area Chart Example
    var ctx = document.getElementById("myTurbidityChart");
    var myTurbidityChart = new Chart(ctx, {
        type: 'line',
        data: {
            labels: [
                <?php foreach ($datas as $data) : ?>
